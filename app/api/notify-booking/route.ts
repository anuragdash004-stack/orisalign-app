        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#faf7f2;padding:20px;border-radius:12px;">
            ...
            <p style="text-align:center;color:#9ca3af;font-size:12px;margin-top:20px;">
              OrisAlign · Chandrasekharpur, Bhubaneswar, Odisha
            </p>
          </div>
        `,
      }),
        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;background:#faf7f2;padding:20px;border-radius:12px;">
              ...
              <p style="color:#6b7280;font-size:13px;line-height:1.7;">Our team will contact you shortly to confirm. For queries, reach us at <a href="https://www.orisalign.com" style="color:#C9A84C;">orisalign.com</a> or call <strong>+91 82808 37370</strong>.</p>
