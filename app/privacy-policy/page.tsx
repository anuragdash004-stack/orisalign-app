      ...
      <div style={{ maxWidth: "820px", margin: "0 auto", padding: "40px 20px", width: "100%", flex: 1, position: "relative" }}>
        ...
        <div style={sec}>
          ...
          <div style={{ background: "#1B2A4A", color: "white", borderRadius: "12px", padding: "20px 24px", fontSize: "14px", lineHeight: "1.8" }}>
            ...
            Data Protection Contact: <a href="mailto:hello@orisalign.com" style={{ color: "#C9A84C" }}>hello@orisalign.com</a><br />
