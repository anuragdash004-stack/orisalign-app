        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex gap-2"><span>📍</span><span>MIG-1, 43/5, Housing Board Colony, Chandrasekharpur, Bhubaneswar – 751016, Odisha</span></div>
          ...
          <div className="border-t pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
            ...
            <div className="flex gap-4">
              <a href="/checkout/login" className="hover:text-white">Checkout</a>
