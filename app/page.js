      ...
      <section className="pt-16 min-h-screen flex items-center" style={{ background: 'linear-gradient(135deg, #FBF7EE 0%, #ffffff 50%, #F5EDD6 100%)' }}>
        <div className="max-w-6xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mb-4 px-4 py-3 rounded-2xl text-sm font-semibold" style={{ background: '#FFF3CD', border: '1.5px solid #f59e0b', color: '#92400e' }}>
          ...
          <div className="rounded-3xl border-2 overflow-hidden shadow-lg" style={{ borderColor: GOLD }}>
            ...
            <div className="px-8 py-6" style={{ background: '#FBF7EE' }}>
              <div className="flex items-center justify-center gap-2 mb-5">
                ...
                <span className="font-black text-base" style={{ color: NAVY }}>Freebies worth ₹9,999 — included with every treatment</span>
              </div>
      ...
      <footer className="py-16 text-gray-300" style={{ background: NAVY }} id="contact">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
            <p>© 2025 OrisAlign. All rights reserved. | Designed by expert dentists</p>
            <div className="flex gap-4">
              <a href="/terms" target="_blank" className="hover:text-white">Terms &amp; Conditions</a>
              <a href="/privacy-policy" target="_blank" className="hover:text-white">Privacy Policy</a>
              <a href="/refund-policy" target="_blank" className="hover:text-white">Refund Policy</a>
