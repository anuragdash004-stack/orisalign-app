  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex gap-2"><span>📞</span><a href="tel:+917978XXXXXX" className="hover:text-white">+91 79780 XXXXX</a></div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 sm:hidden bg-white border-t border-gray-200 px-4 py-3 flex gap-3 shadow-2xl">
        ...
        <a href="https://wa.me/917978XXXXXX?text=Hi%2C+I%27d+like+to+know+more+about+OrisAlign" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-4 py-3 rounded-full flex items-center justify-center">
      ...
      <a
        href="https://wa.me/917978XXXXXX?text=Hi%2C+I%27d+like+to+know+more+about+OrisAlign"
        target="_blank"
